...
<link rel="stylesheet" href="/Public/Admin/layer/skin/layer.css" />
...
<div class="table-box">
	<table>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <?php echo (msubstr(htmlspecialchars_decode($vol["content"]),0,20)); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s', $vol["addtime"])); ?></td>
                <td class="operate">
                	<input type="checkbox" value="<?php echo ($vol["id"]); ?>"/><a href ='javascript:;' class="show" data="<?php echo ($vol["id"]); ?>" data-title="<?php echo ($vol["title"]); ?>" >
...
<div class="pagination ue-clear">
    ...
    <div class="pxofy"><?php echo ($show); ?></div>
</div>
</body>
...
$('.show').on('click',function(){
    ...
    layer.open({
        ...
        shade: 0.8,
        area: ['380px', '90%'],
        content: '/index.php/Admin/Doc/layer/id/' + id //iframe的url
    });
...
$(function(){
    ...
    $('#btnedit').on('click',function(){
        ...
        if( id.length == 1){
            ids = id[0].value;
            window.location.href = '/index.php/Admin/Doc/edit/id/' + ids;
        }else{
            //墨绿深蓝风
