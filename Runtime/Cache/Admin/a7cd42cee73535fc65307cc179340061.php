  ...
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        ...
        <div class="login-msg ue-clear"> <a href="<?php echo U('Email/recBox');?>" target="iframe" class="msg-txt">消息</a> <a href="<?php echo U('Email/recBox');?>" target="_iframe" class="msg-num">0</a> </div>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="gongwen">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>公文起草</span><i class="icon"></i></a></div>
             <ul class="subnav">
              <li><a href="javascript:;" date-src="/index.php/Admin/Doc/showList">公文管理</a></li>
              <li><a href="javascript:;" date-src="/index.php/Admin/Doc/add">添加列表</a></li>
            </ul>
          </li>
          <li class="nav-info">
