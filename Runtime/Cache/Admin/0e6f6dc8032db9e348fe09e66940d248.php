...
<div class="table-box">
	<table>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <?php if($vol["hasfile"] == 1): ?>【<a href="javascript:;" id="btndownload" data="<?php echo ($vol["id"]); ?>">下载</a>】<?php endif; ?>
                </td>
                <td class="content"><?php echo ($vol["content"]); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vol["addtime"])); ?></td>
                <td class="status">
                    <?php if($vol["isread"] == 0): ?><span style="color:green;">已读</span>
                    <?php else: ?>
                    <span style="color:red;">未读</span><?php endif; ?>
                </td>
                <td class="operate">
                	<a href ='javascript:;' id="btndel" data="<?php echo ($vol["id"]); ?>">删除</a> 
                </td>
